...
class LCD(object):
    ...
    def message(self, message, style=2,speed=1):
    ...
    def display_main_screen(self):
        self.message(self.ip + "\n" + "press to coninue")

    def network_check_screen(lcd):
        # Replace LCD with the appropriate LCD library
        startTime = time.time()
        time.sleep(0.5)
